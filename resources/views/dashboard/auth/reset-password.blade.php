            ...
            <div class="col-md-8 col-lg-6 col-xl-5 mx-auto mt-5">
                <div class="card w-100 mt-5">
                    <div class="card-body py-4">
                        ...
                        <form id="reset-password-form" action="{{ route('password.email') }}" method="post" style="position: relative;z-index: 1;">
                            @csrf
                            <input type="hidden" name="token" value="{{ $request->route('token') }}">
                            <div class="input-group d-flex flex-column mb-3">
                                <label for="email" class="fw-bold">@lang('custom.email')</label>
                                <input id="email" name="email" class="form-control w-100" type="email" value="{{ $request->email }}" placeholder="@lang('custom.enter-email')">
                            </div>
                            <div class="input-group d-flex flex-column mb-3">
                                ...
                                <div class="input-holder password-toggler position-relative d-flex justify-content-end">
                                    ...
                                    <input id="password" name="password" class="form-control w-100" type="password" placeholder="@lang('custom.enter-password')">
                                </div>
                            </div>
                            <div class="input-group d-flex flex-column mb-3">
                                <label for="password_confirmation" class="fw-bold">@lang('custom.confirm-password')</label>
                                <div class="input-holder password-toggler position-relative d-flex justify-content-end">
                                    <i class="ri-eye-line fs-4 me-2" role="button"></i>
                                    <input id="password_confirmation" name="password_confirmation" class="form-control w-100" type="password" placeholder="@lang('custom.confirm-password')">
                                </div>
                            </div>
                            <div class="mt-2">
                                <button class="btn btn-primary w-100" type="submit">@lang('custom.reset')</button>
                            </div>
                        </form>
                    </div>
                </div>
